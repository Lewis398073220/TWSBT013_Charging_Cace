...
enum APP_OUTPUT_TYPE_T {
	APP_OUTPUT_TYPE_BOOST5V,
	APP_OUTPUT_TYPE_SENDDATA,
	APP_OUTPUT_TYPE_REVDATA,
	APP_OUTPUT_TYPE_OUTPUTLOW,
};
...
enum APP_EARPHONE_STATUS_T {
	...
	APP_EARPHONE_STATUS_COMM,
	APP_EARPHONE_STATUS_WAIT_FOR_COMM,
	APP_EARPHONE_STATUS_INVALID,
};

enum APP_NTC_STATUS_T {
	APP_NTC_STATUS_STOPCHG,
	APP_NTC_STATUS_NORMAL_HIGH_TEMP,
	APP_NTC_STATUS_NORMAL_LOW_TEMP,
	APP_NTC_STATUS_INVALID,
};
...
#define APP_BATTERY_RECHARGE_MV	 (4100) //电池复充电压
...
#define APP_NTC_NORMAL_MV 		 (1785)     //14.84   15℃
...
#define EARPHONE_OVER_CURRENT_MA     100
